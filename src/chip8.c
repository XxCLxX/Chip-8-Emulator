...
static void chip8_exec_extend_opcode_eight(struct chip8* chip8, unsigned short opcode)
{
    ...
    switch(final_four_bits)
    {
        ...
        // 8xy3 - XOR Vx, Vy. Performs a bitwise XORon Vx and Vy stores the result in Vx
        case 0x03:
            chip8->registers.V[x] = chip8->registers.V[x] ^ chip8->registers.V[y];
        break;
...
static void chip8_exec_extend_opcode_F(struct chip8* chip8, unsigned short opcode)
{
    unsigned char x = (opcode >> 8) & 0x000f;
...
static void chip8_exec_extended(struct chip8 *chip8, unsigned short opcode)
{
    ...
    switch (opcode & 0xf000)
    {
        ...
        // CALL addr, 2nnn - Call subroutine at nn
        case 0x02000:
        ...
        case 0x8000:
            chip8_exec_extend_opcode_eight(chip8, opcode);
        break;
        ...
        // Annn - LD I, addr. Sets the I reigster to nnn
        case 0xA000:
        ...
        case 0xF000:
            chip8_exec_extend_opcode_F(chip8, opcode);
        break;
    }
}
